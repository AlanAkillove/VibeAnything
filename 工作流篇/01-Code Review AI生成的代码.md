...
1. AI 代码的特征是「表面正确，深处有坑」——安全性、边界条件是最薄弱环节，AI 默认不处理这些
2. Review 分四个维度：**安全性、性能、可维护性、边界条件**——每个维度有明确的检查重点和清单
3. 使用 Checklist 确保不遗漏——特别是循环内 IO、空值处理、密钥硬编码这些高频率问题
4. 用 AI 辅助 Review 是高效技巧（交叉验证），但最终判断需要结合你的业务上下文
5. 把重复发现的问题类型加入 Prompt 或 `.cursorrules`，让 AI 在下一次生成时就避免同类问题

---

## 更进一步

- **下一篇文章**：[02-从原型到生产](./02-从原型到生产.md) — Review 通过后如何把代码部署上线
- **相关阅读**：[04-常见陷阱与调试技巧](../工具篇/04-常见陷阱与调试技巧.md) — AI 代码的五大常见陷阱
- **相关阅读**：[01-AI幻觉：识别与验证](../AI协作心法篇/01-AI幻觉：识别与验证.md) — AI 编造 API/库的问题
- **相关阅读**：[07-理解每行AI生成的代码](../AI协作心法篇/07-理解每行AI生成的代码.md) — 代码所有权的建立方法
